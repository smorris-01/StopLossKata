...
{
    public class When_sell_price_does_not_change_before_sell_timeout 
    {
        ...
        private PriceChangedMessage _priceUnchangedBeforeTimeoutMessage = new PriceChangedMessage 
        ...
        public void Setup()
        {
            ...
            _rule.Handle(_priceUnchangedBeforeTimeoutMessage);
        }
